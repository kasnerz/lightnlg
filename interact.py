...
from inference import (
    CausalLMInferenceModule,
    Seq2SeqInferenceModule
)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, choices=["causal_lm", "seq2seq"], required=True,
        help="Decoding mode.")
    ...
    if args.mode == "causal_lm":
        inference_module_cls = CausalLMInferenceModule
    elif args.mode == "seq2seq":
        inference_module_cls = Seq2SeqInferenceModule
